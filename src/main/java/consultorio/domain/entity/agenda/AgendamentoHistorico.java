...
@Entity
@Table(name = "agendamento_historico", indexes = {
        @Index(name = "idx_historico_agendamento", columnList = "agendamento_id"),
        @Index(name = "idx_historico_data", columnList = "data_hora")
})
@Getter
@Setter
@NoArgsConstructor

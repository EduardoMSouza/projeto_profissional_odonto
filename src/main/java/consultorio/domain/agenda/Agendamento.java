...
public class Agendamento {
    ...
    @Column(name = "paciente_id_agendamento", nullable = false)
    private Long pacienteId;

    @Column(name = "paciente_nome_agendamento", nullable = false)
    private String pacienteNome;

    @Column(name = "dentista_id_agendamento", nullable = false)
    private Long dentistaId;

    @Column(name = "dentista_nome_agendamento", nullable = false)
